...
\begin{tikzpicture}[remember picture, overlay]
	\node () at (current page.center) {\includegraphics[width=\pagewidth, height=\pageheight]{../Images/keker_belt_cover.png}};
\end{tikzpicture}
}
{
...
\begin{itemize}
%	\item \textit{Will you recruit a posse of Keker Belters and confront the pirates directly?} \textbf{Threats:} Your posse is killed in action. Kazzark is assassinated by a X'un internee. The Keker Belters force the X'un out of the system.
%	\item \textit{Or will you wage a guerrilla campaign against the pirates on your own?} \textbf{Threats:} Hundreds of Keker Belter and X'un civilians die as they are caught in the crossfire. The Endeavour is captured by the X'un Pirates. The X'un force the Keker Belters out of the system. 
