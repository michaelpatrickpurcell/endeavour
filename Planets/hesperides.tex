...
\subsection*{Crisis}
\begin{itemize}
	\item \textit{Will you proceed to the next iteration of the time loop?} \textbf{Threats:} All Endeavour crew members mark \tikz[baseline=-0.75ex, scale=0.85, transform shape]{\pic {stress_circle};} (Stress). 
