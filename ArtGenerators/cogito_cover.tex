...
%		\node () at (current page.center) {\includegraphics[height=\paperheight, width=\paperwidth]{../Images/voyager.png}};
		...
		\node[fill=LCARS5, minimum width=\pagewidth, anchor=south, minimum height=2cm] () at (0,-\pageheight+0.5ex) {\textcolor{LCARS4}{{\small{An ENDEAVOUR Adventure by Wesley Roberts}}}};
	\end{tikzpicture}
	\end{center}
\end{document}