...
\begin{document}
	...
	\begin{tikzpicture}[remember picture, overlay]
		...
		\node[fill=LCARS5, minimum width=\pagewidth, anchor=south, minimum height=2cm] () at (0,-\pageheight+0.5ex) {\textcolor{LCARS4}{{\small An ENDEAVOUR Adventure by David McKenzie}}};
	\end{tikzpicture}
	\end{center}
\end{document}